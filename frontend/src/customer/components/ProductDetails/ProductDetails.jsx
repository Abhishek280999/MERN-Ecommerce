            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 text-sm">56265 Ratings</p>
                  <p className="ml-3 text-sm font-md text-indigo-600 hover:text-indigo-500">
                    562 Reviews{" "}
                  </p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">58896 Ratings </p>
                </div>
